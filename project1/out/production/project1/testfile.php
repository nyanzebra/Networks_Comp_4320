<?php $pageTitle='Division of Student Affairs' ; include 'includes/header.php'; ?>

<div id="home-slideshow">
    <ul class="rslides">
        <li>
            <div class="item" style="background-image: url(images/header-1.jpg);"></div>
        </li>
        <li>
            <div class="item" style="background-image: url(images/header-2.jpg);"></div>
        </li>
    </ul>
</div>
<div id="link-bar">
    <div class="wrapper">
        ...
        <ul>
            ...
            <li class="icon-rec"><a href="https://cws.auburn.edu/campusRec" target="_blank">Campus Rec</a>
            </li>
            ...
            <li class="icon-health"><a href="https://cws.auburn.edu/studentAffairs/healthAndWellness/" target="_blank">Health &amp; Wellness</a>
            </li>
                ...
                <table class="info">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="mailto:vpsa@auburn.edu">vpsa@auburn.edu</a>
                            </td>
                        </tr>
            ...
            <div class="col span_1_of_3 margins content-block">
                <a href="avp" class="hover-click">
                    <div class="content-block">
                        ...
                        <p>Dean George Flowers, chair of the search for the Assistant Vice President for Engagement and Outreach, announces four finalists.</p>
            ...
            <div class="col span_1_of_3 margins">
                <a href="springsafety" class="hover-click">
                    <div class="content-block">
                        ...
                        <p>A letter from Associate Provost and Vice President for Student Affairs, Dr. Bobby Woodard.</p>
                    </div>
                </a>
            ...
            <div class="col span_1_of_3 margins">
                <a href="kylemarchukprofile" class="hover-click">
                    <div class="content-block">
                        ...
                        <p>Learn more about founder and president of Active Minds at Auburn, Kyle Marchuk.</p>
                    </div>
                </a>
            </div>
